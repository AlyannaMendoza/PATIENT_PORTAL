...
namespace PATIENT_PORTAL.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //if (!user.IsActive)
            //{
            //    ModelState.AddModelError("", "Account is not yet activated. Please contact the admin");
            //    return View(model);
            //}
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (model.ProfileImage != null && model.ProfileImage.ContentLength > 0)
                {
                    ...
                    var extension = System.IO.Path.GetExtension(model.ProfileImage.FileName).ToLower();
                    ...
                    string uploadDir = Server.MapPath("~/Content/images/Users");
                ...
                if (result.Succeeded)
                {
                    if (model.Role.ToString() == "Doctor" || model.Role.ToString() == "Nurse")
                    {
